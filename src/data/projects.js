export const SAMPLE_PROJECTS = [
  ...
  },
  {
    ...
    category: 'Branding',
    emoji: '🔮',
    desc: 'Complete visual identity for a space-tech startup — wordmark, iconography, motion guidelines, and comprehensive brand voice documentation.',
    year: '2023',
...
export const CATEGORIES = ['Design', 'Development', 'Branding', 'Photography', 'Motion', 'Other']

export const CATEGORY_BG = {
  Design:      'bg-design',
  Development: 'bg-dev',
  Branding:    'bg-brand',
  Photography: 'bg-photo',
  Motion:      'bg-motion',
  Other:       'bg-other',
}
